...
<marquee>Selamat datang di Aplikasi Parametrik Jitu, silahkan untuk menginput, memproses dan menganalisis data Anda, Terima Kasih</marquee>
	...
	<div id="menu">
       ...
       <table border="1"><tr><td><center>NO</center></td><td><center>Data Tiga Variabel</center></td><td><center>Hapus</center></td></tr>
		<?php
    //file kelas.php
	$no=1;
	include "db_connect.php";
    ...
    while($kelas = mysql_fetch_array($query)){
    	echo '<tr><td>'.$no.'</td><td><a href="tampil3.php?nama='.$kelas['nama'].'">'.$kelas['nama'].'</a></td><td><a href="delete.php?nama='.$kelas["nama"].'">delete</a></td></tr>';
		$no++;
