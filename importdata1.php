	...
	<div id="menu">
		<ul>
			...
			<li><a href="bantuan.php">Bantuan</a></li>
				...
				<div class="entry">
				<br>
				<div class="entry-title">Upload Data Satu Variabel</div><br>
				Contoh Format Tabel di Excel<br><img src="tabel1.png"></img><br>
...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT into tabel1 (nama,data,x)values('$nama','$no','$x')";
...
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="importdata1.php" method="post" enctype="multipart/form-data">
