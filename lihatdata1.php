...
<marquee>Selamat datang di Web Parametrik Online, silahkan untuk menginput, memproses dan menganalisis data Anda, Terima Kasih</marquee>
	...
	<div id="menu">
       ...
       <table border="0"><tr><td><strong>NO</strong></td><td><center><strong>Data Satu Variabel</strong></center></td></tr>
		<?php
    //file kelas.php
	...
	while($kelas = mysql_fetch_array($query)){
    	echo '<tr><td>'.$no.'</td><td><a href="tampil1.php?nama='.$kelas['nama'].'">'.$kelas['nama'].'</a></td></tr>';
    $no++;
	}?></table>
