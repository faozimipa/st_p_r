	...
	<div id="menu">
		<ul>
			...
			<li><a href="bantuan.php">Bantuan</a></li>
				...
				<div class="entry">
				<br>
				<div class="entry-title">Import Dua Sampel Tidak Berpasangan</div><br>
			Contoh Format Tabel di Excel<br><img src="tabel2tp.png"></img><br>NB : Nama tabel harus yang belum ada atau yang belum tersimpan di aplikasi ini, untuk melihat daftar nama tabel yang sudah ada klik pilihan "Lihat data" pada menu "Data"
<br><br>
		<?php
...
mysql_query ("INSERT INTO tabelt1(nama, data, x, tanggal)VALUES ('$nama1', '$no1', '$x','$tanggal')");
      $query = "INSERT into tabelt2 (nama,data,x, tanggal)values('$nama2','$no2','$y','$tanggal')";
...
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="2importdata2.php" method="post" enctype="multipart/form-data">
