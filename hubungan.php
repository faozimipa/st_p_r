...
.button span span a { display:inline-block; background:url(images/button-bg.gif) left top repeat-x; padding:0 0 3px 0; color:#d5c6bb; width:300px; height:40px;; text-decoration:none; text-transform:uppercase; font-weight:bold;}
...
<marquee>Selamat datang di Aplikasi Parametrik Jitu, silahkan untuk menginput, memproses dan menganalisis data Anda, Terima Kasih</marquee>
	...
	<div id="menu">
		<ul>
			...
			<div class="button"><span><span><a href="korelasi.php">Korelasi 2 Variabel</a></span></span></div>
			<div class="button"><span><span><a href="regresi1.php">Regresi Sederhana</a></span></span></div>
			<div class="button"><span><span><a href="regresi2.php">Regresi Ganda 2 Variabel Independen</a></span></span></div>
